...
export const FULLBODY_LOOKAT: [number, number, number, number, number, number] = [0, 1, 1.5, 0, 1, 0];
export const HALFBODY_LOOKAT: [number, number, number, number, number, number] = [0, 1.5, 1, 0, 1.5, 0];
export const HEADONLY_LOOKAT: [number, number, number, number, number, number] = [0, 1.8, 0.3, 0, 1.7, 0];
