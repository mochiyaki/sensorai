    ...
    return (
        <>
            ...
            >
                ...
                {/* Menu Toggle Button */}
                <Button size="small" onClick={() => setMenuOpen(!menuOpen)} style={{ position: 'absolute', top: '1%', left: '0px', zIndex: 1001 }}>
                    ☰
                </Button>

                {/* Sliding Menu */}
                <div style={{ position: 'absolute', top: '1%', left: menuOpen ? '1%' : '-160px', transition: 'left 0.3s ease', zIndex: 1000, padding: '8px', backgroundColor: 'rgba(0, 0, 0, 0.7)', color: 'white', borderRadius: '8px' }}>
